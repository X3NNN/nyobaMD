...
const makeChatsSocket = (config) => {
    ...
    const appPatch = async (patchCreate) => {
        ...
        if (config.emitOwnEvents) {
            const result = await (0, Utils_1.decodePatches)(name, [{ ...encodeResult.patch, version: { version: encodeResult.state.version }, }], initial, getAppStateSyncKey);
    ...
    */
    ...
    ws.on('CB:notification,type:server_sync', (node) => {
        ...
        if (update) {
            ...
            mutationMutex.mutex(() => (resyncAppState([name])
